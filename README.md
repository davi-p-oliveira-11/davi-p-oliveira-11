...
| **Nexora** <br/> [Live Demo](https://nexora-store.onrender.com/) • [Repository](https://github.com/davi-p-oliveira-11/tripnest)    | React, TypeScript, Node.js, Express, MongoDB | Full Stack e-commerce platform featuring product management, shopping cart, authentication, checkout flow, and an administrative dashboard.                      |
| **Tripnest** <br/> [Live Demo](https://nexora-store.onrender.com/) • [Repository](https://github.com/davi-p-oliveira-11/nexora-store)    | React, TypeScript, Node.js, Express, PostgreSQL | Full-stack hotel booking app built with React + TypeScript, Express, and MongoDB. Clean architecture,, Tailwind 3 for styling.                     |
